...
Button(root,text="C",width=5,height=1,font=("arial",25,"bold"),bd=1,fg='#fff',bg="#3697f5",command=lambda: clear()).place(x=10,y=100)
Button(root,text="/",width=5,height=1,font=("arial",25,"bold"),bd=1,fg='#fff',bg="#2a2d36",command=lambda: show("/")).place(x=130,y=100)
Button(root,text="%",width=5,height=1,font=("arial",25,"bold"),bd=1,fg='#fff',bg="#2a2d36",command=lambda: show("%")).place(x=250,y=100)
Button(root,text="*",width=5,height=1,font=("arial",25,"bold"),bd=1,fg='#fff',bg="#2a2d36",command=lambda: show("*")).place(x=365,y=100)
...
Button(root,text="-",width=5,height=1,font=("arial",25,"bold"),bd=1,fg='#fff',bg="#2a2d36",command=lambda: show("-")).place(x=365,y=180)
...
Button(root,text="+",width=5,height=1,font=("arial",25,"bold"),bd=1,fg='#fff',bg="#2a2d36",command=lambda: show("+")).place(x=365,y=260)
